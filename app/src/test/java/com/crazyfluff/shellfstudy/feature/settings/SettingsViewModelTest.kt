...
class SettingsViewModelTest {
    ...
    fun `uiState reflects opt-in notification defaults`() = runTest {
        ...
        viewModel.uiState.test {
            ...
            assertThat(state.backlogThreshold).isEqualTo(50)
    ...
    fun `category toggles persist without touching scheduling`() = runTest {
        ...
        viewModel.uiState.test {
            ...
            viewModel.onLessonsAvailableEnabledChange(false)
            assertThat(awaitItem().lessonsAvailableEnabled).isFalse()
            viewModel.onMilestonesEnabledChange(false)
            assertThat(awaitItem().milestonesEnabled).isFalse()
        }
